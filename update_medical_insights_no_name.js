...
// Create a clean CSV version without the Name field (since it's auto-numbered)
...
fs.writeFileSync('force-app/main/default/data/medical_insights_final.csv', csvContent);

console.log('Final CSV version (without Name field) written to: force-app/main/default/data/medical_insights_final.csv');
